        ...
        <div className="ases-container grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <div className="space-y-6">
            ...
            <h1 className="ases-display max-w-[11ch]">
              Anyone can <span className="ases-emphasis -rotate-[4deg]">build,</span>
            </h1>
            <p className="ases-copy">
              This pass sets the reusable foundation for the landing page in
              Next.js and Tailwind. It is intentionally a design-system sandbox,
              not the full homepage build.
            </p>
            ...
            <div className="relative space-y-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="ases-stat">
                  ...
                  <p className="text-sm text-muted">Base semantic primitives</p>
                </div>
              </div>
            </div>
          </aside>
      ...
      <section className="ases-section pt-0">
        <div className="ases-container grid gap-10 xl:grid-cols-[0.7fr_1.3fr]">
          <div className="space-y-4">
            ...
            <p className="ases-copy">
              These map directly to Figma variables plus the recurring sky-blue
              accent used in emphasis stickers and active controls.
            </p>
          </div>
            ...
            {colorTokens.map((token) => (
              <article className="ases-card overflow-hidden" key={token.name}>
                ...
                <div className="space-y-2 p-frame">
                  ...
                  <p className="text-sm leading-6 text-muted">{token.usage}</p>
                </div>
              </article>
            ))}
          </div>
      ...
      <section className="ases-section pt-0">
        <div className="ases-container grid gap-10 xl:grid-cols-[0.76fr_1.24fr]">
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <article className="ases-card p-frame">
              <div className="mb-5 flex items-center justify-between gap-4">
                <h3 className="font-display text-title text-ink">Surfaces</h3>
              ...
              <div className="relative grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
                <div className="space-y-4">
                  ...
                  <p className="text-sm leading-6 text-muted">
                    ...
                    then introduce the collage-specific rotations and overlaps at
                    the component level.
                  </p>
                </div>
                <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="ases-container">
          <div className="ases-card p-frame">
            <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
              ...
              <span className="ases-token-chip">see agents.md for scope</span>
            </div>
